...
export const roleCapabilities = {
  ...
  "Support Agent": ["Search shipments", "Assist customers", "Review tracking history", "Create shipments"],
  SUPPORT_AGENT: ["Search shipments", "Assist customers", "Review tracking history", "Create shipments"],
